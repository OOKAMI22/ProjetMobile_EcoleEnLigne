...
public class CustomListAdapterFormation extends BaseAdapter {
    private List<Formation> listData;
    private LayoutInflater layoutInflater;
    private Context context;

    public CustomListAdapterFormation(Context aContext,  List<Formation> listData) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        if (convertView == null) {
            convertView = layoutInflater.inflate(R.layout.list_item_formation, null);
            ...
            holder.prixView = (TextView) convertView.findViewById(R.id.prix);
            convertView.setTag(holder);
        } else {
            holder = (ViewHolder) convertView.getTag();
        }

        Formation formation = this.listData.get(position);
