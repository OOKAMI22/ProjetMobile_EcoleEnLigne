...
public class CustomListAdapterCours extends BaseAdapter{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.descriptionView.setText("Contenu : " + cours.getContenu());
        holder.dureeView.setText("Duree : " + cours.getNbHeure() + " heures");
        holder.prixView.setText("Formation : " + cours.getFormation().getTitre());
